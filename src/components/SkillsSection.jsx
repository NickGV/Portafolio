  ...
  return (
    ...
    >
      <div className="w-full max-w-5xl 2xl:max-w-6xl mx-auto px-4">
        ...
        <div className="bg-card-background rounded-3xl p-6 md:p-12 mt-8">
          <h2 className="text-2xl md:text-3xl font-title font-semibold mt-10 mb-6 md:mb-8 text-paragraph">
            Backend
          </h2>
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6 md:gap-10">
