...
export const HomeSection = () => {
  const { emailCopied, handleEmailCopy } = useEmailCopy(personalInfo.email);

  return (
    <section
      id="Home"
      className="w-full min-h-screen flex items-center px-4 sm:px-6 md:px-8 py-16 sm:py-20"
    >
      <div className="max-w-xs sm:max-w-md md:max-w-2xl lg:max-w-4xl xl:max-w-5xl mx-auto">
        <div className="flex flex-col-reverse lg:flex-row justify-center items-center gap-8 w-full">
          <div className="text-center lg:text-left">
            ...
            <p className="text-paragraph font-paragraph text-base lg:text-lg max-w-prose mb-4">
              Desarrollador Front-end freelance que lleva 2 años aprendiendo y
